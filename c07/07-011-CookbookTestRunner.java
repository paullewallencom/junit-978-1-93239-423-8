...
public class CookbookTestRunner extends TestRunner {
    ...
    public CookbookTestRunner(String fileName, String testClassName)
        ...
        if (fileName != null) {
            ...
            testListener = new CookbookListener();
        }
    ...
    /**
     * The default implementation of TestRunner.start() calls this 
     * method, so we need to override it or else we don't get a 
     * chance to register the TestListener for the TestRunner.
     * Otherwise, override start(), which you might want to do if 
     * extending the TestRunner's supported command-line arguments.
     *
    ...
    /**
     * The CookbookTestRunner constructor runs a test class
     * and collects the reuslts in a TestResult. This accessor 
     * makes the TestResult accessible to clients.
     *
