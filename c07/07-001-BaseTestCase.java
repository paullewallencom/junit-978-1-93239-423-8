...
public class BaseTestCase extends TestCase {
     ...
     * The default log level settingcan be overridden via 
     * -Dlog.level=... on the command line or with a 
     * &lt;sysproperty key="log.level" value="${value}"/&gt;
     * in an Ant &lt;java/&gt; task running this test.
     * Valid values, in ascending order or severity, are 
     * DEBUG, INFO, WARN, ERROR, FATAL_ERROR.
     */
    protected static String logLevel = "INFO";

    /**
     * EMBEDDED <b>staticLogger</b>. This reference is static 
     * and should be used for messages logged from static 
     * code, such as static initializers and TestCase.suite()
     * methods.
     */
    ...
    /**
     * <b>logger</b> is not static and should be used
     * everywhere except in places where a statically 
     * configured logger is necessary.
     */
    protected Logger logger = 
        Hierarchy.getDefaultHierarchy().getLoggerFor("test.");

    /** 
     * Logkit Logger output string format for 
     * non-static <b>logger</b>
     */
     ...
     * and thread info. This one is for the non-static 
     * <b>logger</b>
     */
    protected ExtendedPatternFormatter formatter = 
        new ExtendedPatternFormatter(pattern);

    /**
     * Logkit extended formatter class, provides method 
     * and thread info. This one is for the <b>staticLogger</b>
     */
    protected static ExtendedPatternFormatter staticFormatter = 
        new ExtendedPatternFormatter(staticPattern);

    static {
        setLogLevelFromSystemProperty();
        // log everything to System.out target for now
        StreamTarget target = 
            new StreamTarget(System.out, staticFormatter);
