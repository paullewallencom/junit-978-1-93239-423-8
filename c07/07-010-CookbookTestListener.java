...
public class CookbookTestListener implements TestListener {
    ...
    /**
     * Default constructor creates a CookbookListener that streams
     ...
     * Document and serializes the XML to the specified
     * <code>printStream</code>
     *
     *@param printStream to use for serializing XML reuslts
     *@throws ParserConfigurationException
     */
    ...
    public void startSuite(Test suite) {
        ...
        xmlRoot.setAttributes("class",suite.toString());
